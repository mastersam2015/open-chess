...
location.href = "index2.php?change="+y+"a"+x+"&pion="+aktualny;
...
location.href = "index2.php?change="+y+"a"+x+"&pion="+aktualny+"&bicie="+biciep;
	}
}
  ...
  //alert( "Load was performed." );
	//alert(data);
		  	if(data==2){
				...
				//window.location="index2.php?kolor=n&x="+gox+"&y="+goy+"&ostring="+ostring;	
				window.location="index2.php?reset=4";
				}else if(data==4){
						$("#ready").val("ready");
					//$("#re").show();
				
						// ostring != 0
						//window.location="index2.php?reset=1;
...
fputs($plik2, $huhu);
fclose($plik2);
//echo("<script>location.href='index2.php?change=".$_GET["change"]."&pion=".$_GET["pion"]."';</script>");
header("Location: index2.php?change=".$_GET["change"]."&pion=".$_GET["pion"]);
}
?>
...
header('Location: index2.php?reset=1');
}
...
?><br><br><br>
<input type="button" value="reset" onclick="location.href='index2.php'"> <br><br>
